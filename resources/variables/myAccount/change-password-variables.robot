...
${CHANGE_PASSWORD_TITLE}    xpath=//h2[text()='Change Password']
${SUBMIT_CHANGE_PASSWORD_BUTTON_1}    xpath=//button[text()='Submit']
${SUBMIT_CHANGE_PASSWORD_BUTTON_2}    xpath=//form/button[text()='Submit']
