...
${CHANGE_USER_INFORMATION_TITLE}    xpath=//h2[text()='Change User Information']
${USER_INFORMATION_TITLE}    xpath=//h4[text()='User Information']
${SUBMIT_PROFILE_BUTTON}    xpath=//button[text()='Submit']
${PROFILE_FIRST_NAME_FIELD}    xpath=//input[@id="first_name"]
${PROFILE_LAST_NAME_FIELD}    xpath=//input[@id="last_name"]
${PROFILE_ADDRESS_FIELD}    xpath=//input[@name='address']
${SUBMIT_FORM_PROFILE_BUTTON}    xpath=//form/button[text()='Submit']
${REMOVE_UPLOADED_AVATAR}    xpath=/html/body/div[1]/div/main/div/form/div[2]/div[1]/div/button
${UPLOAD_AVATAR}    xpath=//div[text()='Upload Avatar']

#Message
${UPDATE_PROFILE_SUCCESS}    xpath=//div[text()='Information updated successfully']
